...
# Focus on non-sports categories where single-outcome markets dominate
TARGET_CATEGORIES = [
    'Politics',
    'Economics',
    'Finance',
...
class MarketScanner:
    ...
    async def get_active_markets(self, min_liquidity=100):
        ...
        try:
            for category in TARGET_CATEGORIES:
                ...
                while True:
                    ...
                    if not cursor or len(all_markets) >= 300:
                        break
        ...
        log.info(f"Fetched {len(all_markets)} non-sports single-outcome markets")
        return all_markets
